...
contract  DecentralizedAI is Context, IERC20, Ownable 
{
    ...
    string private constant _name = "Decentralized AI";
    string private constant _symbol = "DEAI";
...
function withdrawETH(address payable recipient, uint256 amount) public onlyOwner {
    ...
    function prepareFoePresale() external onlyOwner() {
       _taxFee = 0;
       _previousTaxFee = 0;
       _maxTxAmount = 10000000000 * 10**18;
    }
